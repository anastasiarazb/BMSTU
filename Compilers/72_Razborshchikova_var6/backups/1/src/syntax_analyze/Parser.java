...
public class Parser {
    ...
    private ArrayList<String> terms;//    = grammar_parser.GrammarStructure.terms;
    private ArrayList<String> nonterms;// = grammar_parser.GrammarStructure.nonterms;
    private Nonterm axiom;//    = grammar_parser.GrammarStructure.axiom;
    private RHS[][] q;// = grammar_parser.GrammarStructure.q;
