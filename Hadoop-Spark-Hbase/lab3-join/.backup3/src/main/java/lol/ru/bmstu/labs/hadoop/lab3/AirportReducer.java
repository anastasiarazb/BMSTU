...
public class AirportReducer extends Reducer<JoinedAirportFlightKey, Text, Text, Text>{
    @Override
    protected void reduce(JoinedAirportFlightKey key, Iterable<Text> values, Context context) throws IOException, InterruptedException{
